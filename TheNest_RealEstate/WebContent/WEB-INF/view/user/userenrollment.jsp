			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<form:form commandName="user"  name="userform"
							class="form-horizontal form-label-left">
							<fieldset style="padding: 13px 0 13px 9px;">

								<form:hidden path="userId" id="path"
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12 col-xs-12 form-group">
										<div class="item form-group">
											...
											<div class="col-md-8 col-sm-6 col-xs-12">
												<form:select path="userRole.userRoleId" required="true" class="required form-control">
		                                 		<option value="" >Select</option>
		                                  		<form:options  items="${userRoles }" itemLabel="userRoleName"  itemValue="userRoleId"  />
		                                  		</form:select>	</div>
										</div>
									</div>
