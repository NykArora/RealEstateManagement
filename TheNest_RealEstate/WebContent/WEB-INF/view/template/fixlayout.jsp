...
<html lang="en">
  <head>
    ...
    <title>Venncare </title>
 <!-- Bootstrap -->
	<link href='<c:url value="/resources/vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css" ></c:url>'  rel="stylesheet" />
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
 ...
 color:black!important;
  ...
  <body class="nav-md footer_fixed"  onload="noBack();" >
...
<tiles:insertAttribute name="footer"></tiles:insertAttribute>
 ...
 <script type="text/javascript" src='<c:url value="/resources/vendors/bootstrap/dist/js/moment.js"></c:url>'></script>
	     <script type="text/javascript" src='<c:url value="/resources/vendors/moment/min/moment.min.js" ></c:url>' ></script>
